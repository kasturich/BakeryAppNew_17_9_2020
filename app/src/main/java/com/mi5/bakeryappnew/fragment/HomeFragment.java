...
import com.mi5.bakeryappnew.adapter.HomeAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*((NavigationDrawerActivity) getActivity()).getSupportActionBar()
                .setTitle(getResources().getString(R.string.nav_header_home));*/

        schemeRecyclerView = view.findViewById(R.id.schemeRecyclerView);
        ...
        homeGridList = new ArrayList<GridModel>();
        ...
        schemeRecyclerView.setLayoutManager(mLayoutManager);
        schemeRecyclerView.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(5), true));
        schemeRecyclerView.setItemAnimator(new DefaultItemAnimator());
        schemeRecyclerView.setAdapter(homeAdapter);
    ...
    private void prepareGrid() {
        int[] covers = new int[]{
                R.mipmap.offer_icon, //0
                R.mipmap.order_icon, //1
                R.mipmap.sell_report, //2
        };

        GridModel a = new GridModel(getActivity().getApplicationContext()
                .getResources().getString(R.string.scheme_title),
                1, covers[0], ContextCompat.getColor(getActivity()
                .getApplicationContext(), R.color.light_grey),
                ContextCompat.getColor(getActivity().getApplicationContext(),
                        R.color.dark_brown));
        homeGridList.add(a);

        a = new GridModel(getActivity().getApplicationContext().getResources()
                .getString(R.string.nav_header_generate_order),
                5, covers[1], ContextCompat.getColor(getActivity()
                .getApplicationContext(),R.color.light_grey),
                ContextCompat.getColor(getActivity().getApplicationContext()
                        ,R.color.dark_brown));
        homeGridList.add(a);
        ...
        a = new GridModel(getActivity().getApplicationContext().getResources()
                .getString(R.string.sell_title),
                2, covers[2], ContextCompat.getColor(getActivity()
                .getApplicationContext(),R.color.light_grey),
                ContextCompat.getColor(getActivity().getApplicationContext(),
                        R.color.dark_brown));
        homeGridList.add(a);
